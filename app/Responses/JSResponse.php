...
class JSResponse implements Responsable
{
    ...
    public static function success(array $data = [], string $message = '', array $metadata = []): self
    {
        return new self(Response::HTTP_OK, $data, $message, null, [], $metadata
        );
    }
    ...
    public static function authenticationException(string $errorMsg): self
    {
        return new self(Response::HTTP_UNAUTHORIZED, [], $errorMsg);
    }
